function [ Indv  ] = poliomodel_Palpost(Indv,vaccinationLevel)
% same as the poliomodel_Pal code but it allows the user to enter the
    ...
    for k=1:8 
        ...
        switch k
            case 1
                ...
                Indv(i,3,k,1:N(k),1,1)= 1;%isAdult
                Indv(i,3,k,1:N(k),1,2)= defaultImmAdult;%isImmune
                Indv(i,3,k,1:N(k),1,3) = defaultAccess;%access to health care
