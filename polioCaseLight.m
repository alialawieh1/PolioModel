function [newCases, activeCases, cumulativeCases ] = polioCaseLight(Indv,nHhold, CaseIntroPopulationType, caseIntroSites, nbCases, nbDays)
%this is a light version of polioCase code with fewer outputs
...
% cumulativeCases is a vector indicating in each day the cumulative number
% of new infected cases
...
newCases(1)=nbCases;
cumulativeCases(1)=sum(newCases);
...
while (nbDays>tempTrackIndv2(1,1))
    ...
    cumulativeCases(j1+1)=sum(newCases);
end
